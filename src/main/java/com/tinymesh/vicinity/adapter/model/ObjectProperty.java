...
import com.tinymesh.vicinity.adapter.model.OutputSchema;
...
public class ObjectProperty   {
   ...
   * @return pid
  **/
  @ApiModelProperty(example = "temp1", required = true, value = "")
  @NotNull
   ...
   * @return monitors
  **/
  @ApiModelProperty(example = "Temperature", required = true, value = "Instance of property from VICINITY core ontology, see http://iot.linkeddata.es/def/core/index-en.html, figure 3 hierarchy of properties and exemplary instances, with \"core:\" prefix removed")
  @NotNull
  ...
  **/
   ...
   * @return readLinks
  **/
  @ApiModelProperty(value = "must be presented for properties to be read")
   ...
   * @return writeLinks
  **/
  @ApiModelProperty(value = "must be presented for properties to be set")
